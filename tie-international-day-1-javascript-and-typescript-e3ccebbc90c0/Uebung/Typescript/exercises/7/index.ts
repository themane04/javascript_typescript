...
Intro:
    ...
    viel zu viel Zeit verschwendet haben, nur weil unser
...
Übung:
    Implementiere swap() was 2 persons erhält und diese dann in umgekehrter Reihenfolge zurückgibt.
    ...
    sondern mit allen Typen funktionieren.
*/
